...
import 'px-code-design/css/px-code-design-demo-styles.js';
import '../px-icon-set.js';
...
Polymer({
  _template: html`
    ...
    <!-- Header -->
    <px-demo-header module-name="px-icon-set" description="Wrapper for the Predix icon set which leverages px-icon. Please refer to the px-icon API and the full list of Predix icons below the demo." mobile="" tablet="" desktop="">
    </px-demo-header>
    ...
    <px-demo-interactive>
      ...
      <px-demo-component-snippet slot="px-demo-component-snippet" element-properties="{{_propsSubset(props.*)}}" element-name="px-icon" parent-name="px-icon-set" links-includes="[&quot;px-icon-set/px-icon-set.html&quot;,&quot;px-icon-set/px-icon.html&quot;]" no-indentation="">
...
`,
  ...
  dynamicLoadIcons: function() {
    var iconCol = [0,1,2,3],
        iconSets = ['px-com', 'px-doc', 'px-fea', 'px-nav', 'px-obj', 'px-utl', 'px-vis'],
        meta = Base.create('iron-meta', {type: 'iconset'}),
        sets = {};
